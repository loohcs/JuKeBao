...
//    self.navigationItem.title = @"中华广场";
...
- (void)showIntroWithCrossDissolve {
    ...
    page1.bgImage = [UIImage imageNamed:@"bg_1"];
    ...
    page2.bgImage = [UIImage imageNamed:@"bg_2"];
    ...
    page3.bgImage = [UIImage imageNamed:@"bg_3"];
...
//    UIBarButtonItem *leftBarBtnItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemBookmarks target:self action:nil];
